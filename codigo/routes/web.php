...
Route::get('/clientes/showendereco', [ClienteController::class, 'showendereco'])->name('cliente.showendereco');;
...
Route::get('/vendas/showvenda', [VendaController::class, 'showvenda'])->name('venda.showvenda');;
...
Route::get('/entradas/showentrada', [EntradaController::class, 'showentrada'])->name('entrada.showentrada');;
