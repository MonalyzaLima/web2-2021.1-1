...
<body>
    <main class="main">
        ...
        <div class="content" style="padding: 1.5em 3em; width: 100% !important;">
            <form action="{{ route('compra.store') }}" method="POST" id="formSale">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label for="" class="text-white">Selecionar Fornecedor</label>
                                ...
                                <th class="p-1 pr-4">
                                    <select required onchange="mudaProduto(1)" id="select_1" class="form-control" name="produto[]">
                                        ...
                                        @foreach ($produtos as $produto)
                                            <option data-valor-unitario="{{ $produto->valorCompra }}" value="{{ $produto->id }}">{{ $produto->nomeProduto }}</option>
                                        @endforeach
                                    </select>
                                </th>
                                <th class="p-1">
