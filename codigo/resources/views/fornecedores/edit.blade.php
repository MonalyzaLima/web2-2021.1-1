                ...
                <form action="{{route('fornecedor.update', ['id' => $fornecedor->id])}}" method="POST">
                   ...
                   <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input type="text" name="cpf" class="form-control @error('cnpj') is-invalid @enderror" placeholder="CPF *" value="{{$fornecedor->cnpj}}" />
                                @error('cnpj')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group">
                                <input type="text" name="telefone" class="form-control @error('telefone') is-invalid @enderror" placeholder="CPF *" value="{{$fornecedor->telefone}}" />
                                @error('telefone')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
