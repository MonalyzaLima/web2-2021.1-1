                ...
                <form action="{{route('cliente.update', ['id' => $cliente->id])}}" method="POST">
                   ...
                   <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input type="text" name="dataNascimento" class="form-control @error('dataNascimento') is-invalid @enderror" placeholder="Data de nascimento *" value="{{$cliente->dataNascimento}}" />
                            ...
                            <div class="col-6">
                                    <div class="form-group">
                                        <a class="btnCustomCancel" href="{{route('cliente.index')}}" role="button">Cancelar</a>
                                    </div>
                                </div>
                                <div class="col-6">
