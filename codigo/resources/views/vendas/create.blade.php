...
<body>
    <main class="main">
        ...
        <div class="content" style="padding: 1.5em 3em; width: 100% !important;">
            <form action="{{ route('venda.store') }}" method="POST" id="formSale">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                        <label for="" class="text-white">Nota fiscal *</label>
                        <input required id="notaFiscal" name="notaFiscal" type="text" class="form-control">
                    </div>
                    <div class="col-md-4">
                    ...
                    <table id="myTable">
                        ...
                        <tbody id="tbody">
                            <tr id="produto_1" class="p-2">
                                ...
                                <th class="p-1">
                                    <input min="1" required onchange="mudaQuantidade(1)" id="quantidade_1" name="quantidade[]" type="number" class="form-control">
                                </th>
                                <th class="p-1">
    ...
    <script>
        ...
        function adicionarProduto(){
            ...
            tr  = `
                    ...
                    <th class="p-1">
                        <input min="1" required onchange="mudaQuantidade(`+numeroProduto+`)" id="quantidade_`+numeroProduto+`" name="quantidade[]" type="number" class="form-control">
                    </th>
                    <th class="p-1">
