                   ...
                   <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" name="nomeProduto" class="form-control @error('nomeProduto') is-invalid @enderror" placeholder="Nome *" value="{{$produto->nomeProduto}}" />
                                @error('nome')
                            ...
                            <div class="row pt-3">
                                <div class="col-6">
                                    <div class="form-group">
                                        <a class="btnCustomCancel" href="{{route('produto.index')}}" role="button">Cancelar</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group text-right">
                                        <input class="btnCustomSubmit" type="submit" name="btnSubmit" class="btnContact" value="Efetuar edição" />
                                    </div>
                                </div>
                            </div> 
                        </div>
